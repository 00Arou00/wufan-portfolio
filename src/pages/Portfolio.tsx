    ...
    sections: [
      ...
      },
      {
        ...
        },
        {
          ...
          cat: "品牌形象",
          year: "2023",
          intro: "为独立精品咖啡品牌打造从命名到视觉语言的完整品牌形象。交付品牌手册及上市传播方案。",
          desc: "为独立精品咖啡品牌打造从命名到视觉语言的完整品牌形象，交付品牌手册、核心信息及上市传播方案。",
          detail: "从零开始为精品咖啡初创品牌构建完整品牌形象 — 从命名工作坊开始，经过 logo 设计和色彩体系开发，最终完成 40 页品牌手册。撰写品牌核心信息、菜单文案、包装语言及上市传播方案，包括新闻稿和社交媒体发布公告。",
          role: "品牌设计师 — 命名、视觉识别、文案、上市策划",
          tags: ["视觉形象", "品牌文案", "视觉语言"],
          accent: "#FFD9A3",
        },
      ],
