...
When the blade is sheathed, success has already arrived.`,
    ...
    },
    {
      ...
      items: [
        ...
        {
  title: "University of Leeds scenic promotional video",
  desc: "A University of Leeds scenic promotional video generated using AI tools in the style of Magpie Murders.",
  type: "branded",
  video: "https://www.youtube.com/embed/xl7O70xzGCo",
},
        {
          title: "Perfume Advertisement",
          desc: "An AI-generated perfume advertisement.",
          type: "documentary",
      video: "https://www.youtube.com/embed/vm0mDFhPJvw",
        },
      ],
    },
  ],
...
{
  title: "利兹大学风景宣传片",
  desc: "使用AI软件生成的“喜鹊谋杀案”风格的利兹大学风景宣传片。",
  type: "branded",
video: "https://player.bilibili.com/player.html?bvid=BV1SqQrBfEz2&page=1&autoplay=0",
},
         {
      title: "香水广告",
      desc: "使用AI软件生成的香水广告片。",
      type: "documentary",
video: "https://player.bilibili.com/player.html?bvid=BV1SqQrBfEKF&page=1&autoplay=0",
    },     
          ],
        },
      ],
